...
tfy start --human
# optional future-shell activation after explicit repo marker + user rc hook:
...
tfy start --human --auto-activate  # create trusted repo marker/script for future-shell auto-activation
